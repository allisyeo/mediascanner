...
// ─── Ключевые слова ────────────────────────────────────────────────────────
const keywords = [
  { id: "kw_1", keyword: "Казахтелеком",         type: "brand",      status: "active", sources: ["TikTok", "Threads"], createdAt: "2026-01-10T09:00:00.000Z" },
  { id: "kw_2", keyword: "интернет не работает", type: "problem",    status: "active", sources: ["TikTok", "Threads"], createdAt: "2026-01-12T10:30:00.000Z" },
  { id: "kw_3", keyword: "мусин",                type: "person",     status: "active", sources: ["TikTok", "Threads"], createdAt: "2026-03-01T09:00:00.000Z" }
];
